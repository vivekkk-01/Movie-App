...
routes.post(
  ...
  validateVideo,
  movieControllers.uploadTrailer
);
...
routes.post(
  ...
  [
    ...
    body("storyLine")
      ...
      .not()
      .isEmpty()
      .withMessage("Story Line is required."),
    body("director")
      .trim()
      .not()
      .isEmpty()
    ...
    body("status")
      .isIn(["public", "private"])
      .withMessage("Status should be public or private."),
      ...
      .custom((cast) => {
        for (let c of cast) {
          ...
          if (typeof c.leadActor !== "boolean")
            throw Error("Lead Actor is Missing!");
        }
        return true;
      }),
    body("writers")
...
routes.get("/search-public", movieControllers.searchPublicMovies);
